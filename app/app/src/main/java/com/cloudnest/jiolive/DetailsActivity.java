...
import com.cloudnest.jiolive.adapters.CastCrewAdapter;
import com.cloudnest.jiolive.adapters.CommentsAdapter;
import com.cloudnest.jiolive.adapters.EpisodeAdapter;
import com.cloudnest.jiolive.adapters.DownloadAdapter;
import com.cloudnest.jiolive.adapters.HomePageAdapter;
import com.cloudnest.jiolive.adapters.ProgramAdapter;
import com.cloudnest.jiolive.adapters.RelatedTvAdapter;
import com.cloudnest.jiolive.adapters.EpisodeDownloadAdapter;
import com.cloudnest.jiolive.adapters.ServerAdapter;
import com.cloudnest.jiolive.database.DatabaseHelper;
import com.cloudnest.jiolive.models.CastCrew;
import com.cloudnest.jiolive.models.GetCommentsModel;
import com.cloudnest.jiolive.models.CommonModels;
import com.cloudnest.jiolive.models.EpiModel;
import com.cloudnest.jiolive.models.PostCommentModel;
import com.cloudnest.jiolive.models.Program;
import com.cloudnest.jiolive.models.SubtitleModel;
import com.cloudnest.jiolive.models.single_details.Cast;
import com.cloudnest.jiolive.models.single_details.Director;
import com.cloudnest.jiolive.models.single_details.DownloadLink;
import com.cloudnest.jiolive.models.single_details.Episode;
import com.cloudnest.jiolive.models.single_details.Genre;
import com.cloudnest.jiolive.models.single_details.RelatedMovie;
import com.cloudnest.jiolive.models.single_details.Season;
import com.cloudnest.jiolive.models.single_details.SingleDetails;
import com.cloudnest.jiolive.models.single_details.Subtitle;
import com.cloudnest.jiolive.models.single_details.Video;
import com.cloudnest.jiolive.models.single_details_tv.AdditionalMediaSource;
import com.cloudnest.jiolive.models.single_details_tv.AllTvChannel;
import com.cloudnest.jiolive.models.single_details_tv.ProgramGuide;
import com.cloudnest.jiolive.models.single_details_tv.SingleDetailsTV;
import com.cloudnest.jiolive.network.RetrofitClient;
import com.cloudnest.jiolive.network.apis.CommentApi;
import com.cloudnest.jiolive.network.apis.FavouriteApi;
import com.cloudnest.jiolive.network.apis.ReportApi;
import com.cloudnest.jiolive.network.apis.SingleDetailsApi;
import com.cloudnest.jiolive.network.apis.SingleDetailsTVApi;
import com.cloudnest.jiolive.network.apis.SubscriptionApi;
import com.cloudnest.jiolive.network.model.ActiveStatus;
import com.cloudnest.jiolive.network.model.config.AdsConfig;
import com.cloudnest.jiolive.network.model.FavoriteModel;
import com.cloudnest.jiolive.database.continueWatching.ContinueWatchingModel;
import com.cloudnest.jiolive.database.continueWatching.ContinueWatchingViewModel;
import com.cloudnest.jiolive.service.DownloadWorkManager;
import com.cloudnest.jiolive.utils.HelperUtils;
import com.cloudnest.jiolive.utils.PreferenceUtils;
import com.cloudnest.jiolive.utils.RtlUtils;
import com.cloudnest.jiolive.utils.TrackSelectionDialog;
import com.cloudnest.jiolive.utils.ads.BannerAds;
import com.cloudnest.jiolive.utils.Constants;
import com.cloudnest.jiolive.utils.ads.PopUpAds;
import com.cloudnest.jiolive.utils.ToastMsg;
import com.cloudnest.jiolive.utils.Tools;
...
import static com.cloudnest.jiolive.utils.Constants.CATEGORY_TYPE;
import static com.cloudnest.jiolive.utils.Constants.CONTENT_ID;
import static com.cloudnest.jiolive.utils.Constants.CONTENT_TITLE;
import static com.cloudnest.jiolive.utils.Constants.IMAGE_URL;
import static com.cloudnest.jiolive.utils.Constants.IS_FROM_CONTINUE_WATCHING;
import static com.cloudnest.jiolive.utils.Constants.POSITION;
import static com.cloudnest.jiolive.utils.Constants.SERVER_TYPE;
import static com.cloudnest.jiolive.utils.Constants.STREAM_URL;
...
public class DetailsActivity extends AppCompatActivity implements CastPlayer.SessionAvailabilityListener, ProgramAdapter.OnProgramClickListener, EpisodeAdapter.OnTVSeriesEpisodeItemClickListener,
    ...
    private LinearLayout downloadBtContainer;
    ...
    public void initViews() {
        ...
        downloadBtContainer = findViewById(R.id.downloadBt_container);
    ...
    public void initMoviePlayer(String url, String type, Context context) {
        Log.e(TAG, "initMoviePlayer: " + type);
        serverType = type;
        urlType = type;
    ...
    public void initVideoPlayer(String url, Context context, String type) {
        ...
        if (!type.equalsIgnoreCase("youtube") &&
                !type.equalsIgnoreCase("youtube-live")) {
            try {
    ...
    private void initYoutubePlayer(String url) {
        ...
        System.out.println("Playing youtube video from:");
        ...
        call.enqueue(new Callback<SingleDetails>() {
            ...
            public void onResponse(Call<SingleDetails> call, retrofit2.Response<SingleDetails> response) {
                if (response.code() == 200) {
                    ...
                    castImageUrl = singleDetails.getThumbnailUrl();
                    downloadBt.setVisibility(GONE);
                    downloadBtContainer.setVisibility(GONE);
                    if (trailerUrl == null || trailerUrl.equalsIgnoreCase("")) {
                        trailerBt.setVisibility(GONE);
                        downloadBtContainer.setVisibility(GONE);
                    } else {
                        downloadBtContainer.setVisibility(VISIBLE);
        ...
        seasonDownloadSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                seasonDownloadRecyclerView.setLayoutManager(new LinearLayoutManager(DetailsActivity.this,
                        RecyclerView.VERTICAL, false));
                EpisodeDownloadAdapter adapter = new EpisodeDownloadAdapter(DetailsActivity.this, selectedSeasonDownloadList);
