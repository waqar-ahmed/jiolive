package com.cloudnest.jiolive.nav_fragments;
...
import com.cloudnest.jiolive.network.apis.CountryApi;
import com.cloudnest.jiolive.network.model.config.AdsConfig;
import com.cloudnest.jiolive.utils.ApiResources;
...
import com.cloudnest.jiolive.utils.SpacingItemDecoration;
            ...
            public void onResponse(Call<List<AllCountry>> call, retrofit2.Response<List<AllCountry>> response) {
                if (response.code() == 200){
                    ...
                    for (int i = 0; i < response.body().size(); i++) {
                        ...
                        //models.setVideoType("tv"); // To show tv channels from country we set type manually here to tv
                        list.add(models);
                    }
                    mAdapter.notifyDataSetChanged();
                }else {
