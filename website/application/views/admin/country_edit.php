...
<div class="form-group">
  ...
  <div class="col-sm-12" >
    <div class="profile-info-name text-center"> <img id="thumb_image" src="<?php echo $this->common_model->get_country_image_url($row['country_id']); ?>" class="img-thumbnail" alt="genre" width="120"> </div>
    <br>
