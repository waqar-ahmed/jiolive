...
<h4 class="text-center">Add Subtitle</h4>
<hr>
...
<div class="form-group row">
  <label class="col-sm-3 control-label">Kind</label>
  <div class="col-sm-9 ">
...
<div class="form-group row">
  <label class="col-sm-3 control-label">Upload .vtt File</label>
  <div class="col-sm-9 ">
...
<div class="form-group row">
  <label class="col-sm-3 control-label">OR .vtt From URL</label>
  <div class="col-sm-9 ">
...
<div class="form-group row">
  ...
  <div class="col-sm-9 ">
      <p>Note: only .vtt is supported.You have convert SubRip to WebVTT  from <a href="https://atelier.u-sub.net/srt2vtt/" target="_blank">Here</a></p>
  </div>
</div>
