...
<div class="card">
    <div class="row">
        ...
        <b><?php echo $live_tv['stream_from']; ?></b>
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <select  class="form-control"  name="stream_from" required>
              ...
              <option value="youtube_live" <?php if($live_tv['stream_from'] =='youtube_live'){ echo 'selected';} ?>>Youtube Live</option>
        ...
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <select  class="form-control"  name="stream_from1">
              ...
              <option value="youtube_live" <?php if($this->live_tv_model->get_stream_from($live_tv['live_tv_id'],'opt1') =='youtube_live'){ echo 'selected';} ?>>Youtube Live</option>
        ...
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <select  class="form-control"  name="stream_from2">
              ...
              <option value="youtube_live" <?php if($this->live_tv_model->get_stream_from($live_tv['live_tv_id'],'opt2') =='youtube_live'){ echo 'selected';} ?>>Youtube Live</option>
                ...
                <select class="form-control select2" name="country" id="country">
                    <optgroup label="Select Country">
                      <?php $country = $this->db->get('country')->result_array();
                            ...
                            <option value="<?php echo $v_country['country_id']; ?>" <?php  if(preg_match('/\b'.$v_country['country_id'].'\b/', $live_tv['country_id'])){ echo "selected";} ?>><?php echo $v_country['name']; ?></option>
                      <?php endforeach; ?>
                </select>
            </div>
          </div>
