            ...
            <?php echo form_open_multipart(base_url('admin/movie_file_update/'.$video_file_info->video_file_id)); ?>           
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="source" id="selected-source">
                  <option value="upload" <?php if($video_file_info->file_source =='upload'): echo 'selected'; endif;?>><?php echo trans('upload');?></option>
                  <option value="youtube" <?php if($video_file_info->file_source =='youtube'): echo 'selected'; endif;?>><?php echo trans('youtube');?></option>
                  <option value="vimeo" <?php if($video_file_info->file_source =='vimeo'): echo 'selected'; endif;?>><?php echo trans('vimeo');?></option>
                  <option value="amazone" <?php if($video_file_info->file_source =='amazone'): echo 'selected'; endif;?>><?php echo trans('amazone_s3');?></option>
                  <option value="mp4" <?php if($video_file_info->file_source =='mp4'): echo 'selected'; endif;?>><?php echo trans('mp4_from_url');?></option>
                  <option value="mkv" <?php if($video_file_info->file_source =='mkv'): echo 'selected'; endif;?>><?php echo trans('mkv_from_url');?></option>
                  <option value="webm" <?php if($video_file_info->file_source =='webm'): echo 'selected'; endif;?>><?php echo trans('webm_from_url');?></option>
                  <option value="m3u8" <?php if($video_file_info->file_source =='m3u8'): echo 'selected'; endif;?>><?php echo trans('m3u8_from_url');?></option>
                  <option value="embed" <?php if($video_file_info->file_source =='embed'): echo 'selected'; endif;?>><?php echo trans('embed_url');?></option>
                  </select>
              </div>
