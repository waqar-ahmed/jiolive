                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Received from:</span> '.$name.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Email:</span> '.$email.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Requiested For :</span> '.$movie_name.'</p>                                                   
                                                        <p><span style="font-weight:bold;font-size:16px;">Message Bellow:</span> </p>
                                                    ...
                                                    <tr>
                                                        <td style="font-size:16px;line-height:22px;text-align:center;max-width:650px">
                                                            <a href="http://spagreen.net" style="text-decoration:none;color:#69696c" target="_blank">
                                                                ...
                                                                Ovoo-Movie & Video Steaming CMS Pro
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="color:#b4b4b4;font-size:11px;padding-top:10px;line-height:15px;font-family:arial">
                                            <span> &copy; '.$site_name.' '.date("Y").' - ALL RIGHTS RESERVED </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Your Name:</span> '.$name.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Your Email:</span> '.$email.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Requiested For :</span> '.$movie_name.'</p>                                                   
                                                        <p><span style="font-weight:bold;font-size:16px;">Message Bellow:</span> </p>
                                                        <p style="margin-bottom:0;"> '.nl2br($message).' </p>
                        ...
                        <td>
                            <table style="max-width:650px" align="center">
                                <tbody>
                                    <tr>
                                        <td style="color:#b4b4b4;font-size:11px;padding-top:10px;line-height:15px;font-family:arial">
                                            <span> &copy; SPA GREEN CREATIVE 2015 - '.date("Y").' - ALL RIGHTS RESERVED </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
