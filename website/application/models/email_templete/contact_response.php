                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        <h3><span style="font-weight:bold;font-size:20px">We will response you shortly.</span></h3>  
                                                        <p><span style="font-weight:bold;font-size:18px">Your Message Details</span></p>                                                      
                                                        <p><span style="font-weight:bold;font-size:16px">Name:</span> '.$name.'</p>
