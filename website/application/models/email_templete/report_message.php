                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Movie Name:</span> '.$video->title.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Video Error:</span> '.$video_msg.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Audio Error:</span> '.$audio_msg.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Subtitle Error:</span> '.$subtitle_msg.'</p>                                                    
                                                        <p><span style="font-weight:bold;font-size:16px;">Message below:</span> </p>
