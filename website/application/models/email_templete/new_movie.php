                                                ...
                                                <td style="background:#fff;border:1px solid #D8D8D8;padding:30px 30px" align="center">
                                                    ...
                                                    <table align="center">
                                                       ...
                                                       <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:center;">
                                                            ...
                                                            <h4  style="color:#005f84;padding-bottom:10px;" data-mce-style="font-family: impact, sans-serif;">by &nbsp;'.$site_name.'</h4>
                                                            ...
                                                            <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                                ...
                                                                <p><span style="font-weight:bold;font-size:16px">Release Date:</span> '.$video->release.'</p>
                                                                <p><span style="font-weight:bold;font-size:16px">Actor: </span> '.$actor.'</p>
                                            ...
                                            <tr>
                                                <td style="background:#f9f9f9;border:1px solid #D8D8D8;border-top:none;padding:24px 10px" align="center">
                                                    ...
                                                    <table style="width:100%;max-width:650px" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td style="font-size:16px;line-height:27px;text-align:center;max-width:650px">
                                                                    <a href="https://ovoo.spagreen.net" style="text-decoration:none;color:#69696c" target="_blank">
